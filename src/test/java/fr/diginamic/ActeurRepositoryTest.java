...
public class ActeurRepositoryTest {
    ...
    public void testExtraireActeursParIdentite() {
        TypedQuery<Acteur> query = em.createQuery("SELECT a FROM Acteur a where a.identite = :x", Acteur.class);
        query.setParameter("x", "Marion Cotillard");
        List<Acteur> acteurs = query.getResultList();
    ...
    public void testExtraireActeursParRole() {
        ...
        TypedQuery<Acteur> query = em.createQuery("SELECT a FROM Acteur a join a.roles r where r.nom = :x",
                Acteur.class);
        query.setParameter("x", "Harley Quinn");
    ...
    public void testExtraireActeursParFilmParuAnnee() {
        TypedQuery<Acteur> query = em.createQuery("SELECT a from Acteur a join a.roles r where r.film.annee= :x",
                Acteur.class);
        query.setParameter("x", 2015);
        List<Acteur> acteurs = query.getResultList();
    ...
    public void testExtraireActeursParPays() {
        TypedQuery<Acteur> query = em.createQuery("SELECT a FROM Acteur a join a.roles r join r.film f join f.pays p where p.nom = :x",
                Acteur.class);
        query.setParameter("x", "France");
        List<Acteur> acteurs = query.getResultList();
    ...
    public void testExtraireActeursParListePaysEtAnnee() {
        TypedQuery<Acteur> query = em.createQuery("SELECT a FROM Acteur a join a.roles r join r.film f join f.pays p " +
                "where f.annee = :x and p.nom = :y",
                Acteur.class);
        query.setParameter("x", 2017);
        query.setParameter("y", "France");
        List<Acteur> acteurs = query.getResultList();
    ...
    public void testExtraireParRealisateurEntreAnnee() {
        TypedQuery<Acteur> query = em.createQuery("SELECT a FROM Acteur a join a.roles r join r.film f join f" +
                        ".realisateurs real where real.identite = :x and f.annee between :y and :z",
                Acteur.class);
        query.setParameter("x", "Ridley Scott");
        query.setParameter("y", 2010);
        query.setParameter("z", 2020);
    ...
    public void testExtraireRealisateursParActeur() {
        TypedQuery<Realisateur> query = em.createQuery("SELECT r FROM Realisateur r join r.films f join f.roles r2 join r2.acteur a where a.identite = :x",
                Realisateur.class);
        query.setParameter("x", "Brad Pitt");
